...
<title>Registro de clientes||Corpoelec</title>
...
<div class="center mt-5">
    <div class="card pt-3" >
            <p style="font-weight: bold; color: #0F6BB7; font-size: 22px;">Lista de Clientes</p>
...
<tbody>
            <?php $busqueda=mysqli_query($conexion,"SELECT * FROM cliente "); 
...
<td style="vertical-align: middle;"><?php echo $resultado["dni"]; ?></td>
<td style="vertical-align: middle;"><?php echo $resultado["correo"]; ?></td>
<td style="vertical-align: middle;"><?php echo $resultado["cuenta"]; ?></td>
<td style="vertical-align: middle;"><?php echo $resultado["telefono"]; ?></td>
</tr>    
...
<div>
<form method="POST" action="crear_excel.php">
